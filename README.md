...
<p align="center">
  ...
  <a href="#model-egitimi">Model Eğitimi</a> •
  <a href="#goruntu">Görüntü</a> •
  <a href="#uretken-ai">Üretken AI</a> •
...
> [!TIP]
> Bu README statik bir özet. Etkileşimler ve JavaScript burada değil, [canlı GitHub Pages sitesinde](https://lhasanseker.github.io/yapay-zeka-nasil-calisir/) çalışır. `index.html` dosyası; öğrenme döngüsü, piksel/convolution, token tahmini, difüzyon ve güvenlik risklerini canlı hale getirir.

> [!NOTE]
> README içindeki Python ve PyTorch blokları çalıştırılabilir örneklerdir ancak GitHub sayfasında otomatik çalışmaz. Bunları bilgisayarında Python ortamında çalıştırabilirsin.
